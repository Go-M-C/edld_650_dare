...
*Answer:*
Per our inspection, each row is a state-year observation nested in state clustering unit. We are less concerned with the missingness existed in the eval_year, class_remove_year, and suspension_year because we have converted them to dichotomous by generating policy predictor variables at the previous step. 
46 missing observations exist within the ODR outcomes and enrollment demographics respectively. 
```{r}
